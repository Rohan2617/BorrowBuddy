    ...
    <?php if(Route::has('login')): ?>
        ...
        <?php else: ?>
            <div class="nav__right nav__elem--ceil">
                <a class="nav__a--small" href="<?php echo e(route('login')); ?>">Log in</a>

                <?php if(Route::has('register')): ?>
                    <a class="nav__a--small" href="<?php echo e(route('register')); ?>">Register</a>
                <?php endif; ?>
            </div>
        <?php endif; ?>
    <?php endif; ?>
...
<?php /**PATH C:\Users\Rohan\Downloads\library-management-system-laravel-main\resources\views/nav.blade.php ENDPATH**/ ?>